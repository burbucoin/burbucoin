...
static const int64 MAX_MONEY = 8400000000 * COIN; //8.4  billion total coins
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY = 30;
static const int64 DEV_FEE = 60000;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // burbucoin: 480 blocks found a day. Priority cutoff is 1 burbucoin day / 250 bytes.
    }
